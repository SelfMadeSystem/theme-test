        ...
        <span {...props}>
            ...
            >
                <div className="rounded-full w-6 h-6" style={{
                    background: `linear-gradient(135deg, rgba(${color.r}, ${color.g}, ${color.b}, ${color.a ?? 1}) 50%, rgb(${color.r}, ${color.g}, ${color.b}) 50%)`
                }} />
            </button>
            {open && createPortal(
                <div className="absolute z-10" ref={ref} style={{ top: position.top, left: position.left }}>
